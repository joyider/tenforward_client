# tenforward_client (c) 2019 by Andre Karlsson<andre.karlsson@protractus.se>
#
# .---.        .---.                              . 
#   |          |                                  | 
#   | .-. .--. |--- .-. .--..  .    ._.-.  .--..-.| 
...
#
#
# Filename: metric_oracle by: andrek
# Timesamp: 2019-02-17 :: 15:31
...
class CpuUpdate(UpdateInterface):
	...
	"""TenForward Oracle plugin.
	'stats' is a dictionary that contains the Oracle utilization as a
	percentage.
	"""
